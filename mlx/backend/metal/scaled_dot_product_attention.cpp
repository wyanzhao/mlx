...
bool ScaledDotProductAttention::use_fallback(
  ...
  // It is further gated to the causal shapes where the head-dim-split kernel
  // beats the unfused graph (measured on M5 Max): every shape with
  // qL >= 1024, rectangles against a long cache included. Below that there
  // are too few query blocks to fill the machine (512x8192 measures 1.08x of
  // unfused).
